...
static void VerificarEMover(string pathOrigem, string pathDestino)
{
    try
    {
        MoverArquivo(pathOrigem,pathDestino);
    }
...
MoverArquivo("./Archies/brasil_estados.csv","./Globo/America_do_Sul/Brasil/brasil_estados.csv");//Há a necessidade de passar além do diretório o nome do arquivo que se deseja mover.